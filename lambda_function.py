...
def lambda_handler(event, context):
    ...
    if not items:
        return {
            ...
            "body": json.dumps({"error": "No facts found in the database."})
        }
    ...
    messages = [
        {
            "role": "user",
            "content": f"Take this java fact and make it fun and engaging in 1-2 sentences maximum. Keep it short and witty: {fact}"
        }
    ]
    ...
    try:
        ...
        resp = bedrock.invoke_model(
            modelId="arn:aws:bedrock:us-east-2:AQUI VA TU MODEL",
